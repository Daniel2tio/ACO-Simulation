...
class Pheromone:
    def __init__(self, position, direction, type="Food"):
        ...
        self.evaporation_rate = FOOD_PHEROMONE_EVAPORATION_RATE
        self.home_evaporation_rate = HOME_PHEROMONE_EVAPORATION_RATE
        self.color = RED
        self.type = type
        self.radius = PHEROMONE_RADIUS

    def Update(self):
        # Alter the pheromone state
        if self.type == "food":
    ...
    def Combine(self, other):
        # Merge pheromones that are too close to each other 
...
class PheromoneMap:
    def __init__(self):
        ...
        self.pheromone_dispersion = PHEROMONE_LAY
        self.radius = 2

    def ErasePheromone(self,screen, showFoodTrail, showHomeTrail):
        # Removing pheromones as they evaporate
    ...
    def AppendPheromone(self, position, direction, pher_type="food"):
        # Add pheromone based on what type it is
